    ...
    <div className="p-6 relative">
      ...
      <div className="flex items-center justify-between mt-auto">
        <div className="flex flex-col">
          <span className="text-[10px] text-slate-500 uppercase font-black tracking-widest">Visites</span>
          <span className="text-xl font-black text-green-400">{business.visits}</span>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 mb-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-xs font-black text-accent uppercase tracking-[0.3em] mb-3">La Preuve en Image</h2>
          ...
          >
            Rejoignez les centaines d'entrepreneurs qui ont transformé leur simple lien WhatsApp en une boutique de renommée nationale.
          </motion.p>
        </div>
      </div>

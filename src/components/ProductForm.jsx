...
const ProductForm = ({
  ...
  const inputClasses =
    "w-full p-4 bg-white/5 border border-white/5 rounded-2xl outline-none focus:bg-white/[0.08] focus:border-green-500/30 text-slate-900 dark:text-white text-sm placeholder:text-slate-500 dark:placeholder:text-slate-600 transition-all font-medium";
    ...
    return (
      <div className="p-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <select
              ...
              className="w-24 p-4 bg-white/5 border border-white/5 rounded-2xl outline-none text-slate-900 dark:text-white text-xs font-bold uppercase tracking-widest"
            >
        ...
        <button
          ...
          className="w-full text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest hover:text-blue-400 flex items-center justify-center gap-1 py-2 transition-colors"
        >
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-4 space-y-4">
          <div className="relative group aspect-square rounded-[2rem] overflow-hidden border-2 border-dashed border-slate-300 dark:border-white/10 hover:border-green-500/30 transition-all bg-slate-50 dark:bg-white/[0.02]">
            {displayImage ? (
              <>
                <img
                  src={displayImage}
                ...
                <div className="absolute inset-0 bg-slate-950/60 opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center gap-4">
                  <button
                    type="button"
                    onClick={() => fileInputRef.current?.click()}
                    className="bg-white text-slate-900 px-5 py-2 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:scale-105 transition-transform"
                  >
              ...
              >
                <div className="w-16 h-16 bg-slate-100 dark:bg-white/5 rounded-3xl flex items-center justify-center text-slate-500 dark:text-slate-500 group-hover:text-green-600 dark:group-hover:text-green-500 transition-colors">
                  <ImageIcon size={32} />
                </div>
                <div className="text-center">
                  <span className="block text-[10px] font-black text-slate-600 dark:text-slate-500 uppercase tracking-widest mb-1">
                    Ajouter une photo
                  </span>
                  <span className="text-[9px] text-slate-500 dark:text-slate-600 font-bold uppercase">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2">
                  ...
                  <select
                    ...
                    className="w-24 p-4 bg-white/5 border border-slate-200 dark:border-white/5 rounded-2xl outline-none text-slate-900 dark:text-slate-400 text-xs font-black uppercase tracking-widest focus:border-green-500/30"
                  >
                    <option value="CDF">CDF</option>
                    <option value="USD">USD</option>
                  </select>

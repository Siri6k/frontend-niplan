...
const BusinessProfile = () => {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col font-sans selection:bg-green-500/30 overflow-x-hidden pt-10 pb-24">
      {/* Background Decor */}
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4">
        ...
        >
          <div className="p-3 bg-blue-500/10 text-blue-600 dark:text-blue-500 rounded-2xl border border-blue-500/20">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest mt-1">
              Personnalisez votre identité commerciale
            </p>
          </div>
        </motion.div>
